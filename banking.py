...
def display_menu(accounts):
    ...
    while True:
        print("\n--- Banking Menu ---")
        print("1. Make a deposit") #JH234567
        print("2. Make a withdrawal")
        print("3. Check balance")
        print("4. Check another account")
        print("5. Create a new account")
        print("6. Show lexer and parser results") #CREATE ACCOUNT John,Lewis,JL123456,500
        ...
        if choice == '1':
            ...
            banking_commands = input("Enter banking commands: ")
            lexer = Lexer(banking_commands)
